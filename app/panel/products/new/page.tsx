          ...
          <form onSubmit={handleSubmit} className="space-y-8 max-w-6xl mx-auto">
            ...
            <div className="flex justify-end gap-4 pt-8 border-t border-slate-200/60">
              ...
              <Button 
                type="submit" 
                disabled={isSubmitting}
                className="h-12 px-8 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-medium shadow-lg hover:shadow-xl transition-all duration-200"
              >
                {isSubmitting ? (
                  <>
