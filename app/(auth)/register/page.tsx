    ...
    <div className="fixed inset-0 flex bg-gradient-to-br from-slate-900 via-blue-950 to-blue-900 overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col items-center justify-center relative p-12">
        <div className="relative z-10 text-center">
          ...
          <h2 className="text-3xl font-bold text-white mb-3">Creá tu cuenta</h2>
          <p className="text-blue-200 text-lg max-w-xs mx-auto">Unite a miles de clientes que ya compran en TechZone CDE</p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 overflow-y-auto">
        <div className="w-full max-w-md py-6">
          {/* Logo mobile */}
          <Link href="/" className="flex justify-center mb-6 lg:hidden">
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-6 border border-white/20">
            ...
            {!showVerification ? (
              <>
                <div className="mb-4">
                  <h1 className="text-2xl font-bold text-gray-900 mb-0.5">Crear cuenta</h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-2.5">
                  <div className="space-y-1">
                    <Label htmlFor="name" className="text-xs font-semibold text-gray-700">Nombre completo</Label>
                    <div className="relative">
                      <User className="absolute left-3 top-1/2 h-3.5 w-3.5 -translate-y-1/2 text-gray-400" />
                      <Input id="name" type="text" placeholder="Tu nombre completo" value={name}
                        onChange={(e) => setName(e.target.value)}
                        className="pl-9 h-10 text-sm border-gray-200 bg-gray-50 focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500/15 rounded-xl transition-all" required />
                    </div>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      ...
                      <Input id="password" type={showPassword ? "text" : "password"} placeholder="Mínimo 6 caracteres" value={password}
                        ...
                        className="pl-9 pr-10 h-10 text-sm border-gray-200 bg-gray-50 focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500/15 rounded-xl transition-all" required />
                      <button type="button" onClick={() => setShowPassword(!showPassword)}
                        className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-700 transition-colors" tabIndex={-1}>
                  ...
                  <div className="space-y-1">
                    <Label htmlFor="confirmPassword" className="text-xs font-semibold text-gray-700">Confirmar contraseña</Label>
                    <div className="relative">
                      <Lock className="absolute left-3 top-1/2 h-3.5 w-3.5 -translate-y-1/2 text-gray-400" />
                      <Input id="confirmPassword" type={showConfirmPassword ? "text" : "password"} placeholder="Repetí la contraseña" value={confirmPassword}
                  ...
                  <div className="flex items-start gap-2.5 p-3 bg-gray-50 rounded-xl border border-gray-200">
                    ...
                    <Label htmlFor="acceptTerms" className="text-xs leading-relaxed cursor-pointer text-gray-600">
                      Acepto los{" "}
                      <Link href="/terminos-y-condiciones" className="text-blue-600 font-semibold hover:underline" target="_blank">Términos</Link>
                      {" "}y la{" "}
                      <Link href="/politica-de-privacidad" className="text-blue-600 font-semibold hover:underline" target="_blank">Política de Privacidad</Link>
                    </Label>
                  </div>

                  <Button type="submit"
                    className="w-full h-10 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200"
                ...
                <div className="mt-3 relative">
                  ...
                  <div className="relative flex justify-center text-xs">
                    <span className="px-3 bg-white text-gray-400 uppercase tracking-widest font-medium">O registrate con</span>
                  </div>
                </div>

                <Button type="button" variant="outline" onClick={handleGoogleLogin} disabled={isLoading}
                  className="mt-3 w-full h-10 border-2 border-gray-200 hover:border-blue-400 bg-white hover:bg-blue-50 text-gray-700 font-semibold rounded-xl transition-all duration-200">
                ...
                <p className="mt-3 text-center text-sm text-gray-500">
                  ¿Ya tenés cuenta?{" "}
                  <Link href="/login" className="text-blue-600 hover:text-blue-700 font-semibold transition-colors">Iniciá sesión</Link>
                </p>
              </>
            ) : (
              <div className="text-center py-4">
                ...
                <p className="text-gray-600 text-sm mb-1">Te enviamos un link de verificación a:</p>
                <p className="font-semibold text-gray-900 mb-4">{email}</p>
                <p className="text-sm text-gray-500 mb-6">Revisá tu bandeja de entrada y hacé click en el link para activar tu cuenta.</p>
                <div className="space-y-3">
                  <Button onClick={() => router.push("/login")} className="w-full h-12 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold rounded-xl">
                    Ir al inicio de sesión
                  </Button>
                  <Button variant="outline" onClick={handleResendEmail} disabled={isLoading} className="w-full h-11 border-2 border-gray-200 rounded-xl">
